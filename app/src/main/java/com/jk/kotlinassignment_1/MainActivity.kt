...
class MainActivity : AppCompatActivity()
{
    ...
    fun addData()
    {
        ...
        carList.add(GeneralMoters("Chevrolet Cruze",2001,800,false,true,
            19000.00))
        carList.add(GeneralMoters("Chevrolet Malibu",2010,1200,false,true,
            30000.00))
        carList.add(GeneralMoters("GMC terrain",2008,1500,true,true,
            22000.00))
        carList.add(GeneralMoters("Cadillac XT6",2019,1300,false,true,
            45000.00))
        carList.add(GeneralMoters("Buick Encore",2011,600,false,false,
            12000.00))
        carList.add(GeneralMoters("Buick Regal",1970,1100,false,true,
            28000.00))
    }
